...
while(1){
    ...
    switch(pressed_key){        
        case 1: LCD_clear(); printC(0,0,'R'); break;
        
        case 2: LCD_clear(); printC(0,8,'R'); break;
        
        case 3: LCD_clear(); printC_5x7(0,0,'R'); break;
        
        case 4: LCD_clear(); printC_5x7(0,8,'R'); break;
        
        case 5: LCD_clear(); print_Line(0,"!@#$%^&*()~"); break;
        
        case 6: LCD_clear(); print_Line(1,"!@#$%^&*()~"); break;
        
        case 7: LCD_clear(); printS(3,20,"RMIT SST"); break;
        
        case 8: LCD_clear(); printS_5x7(6, 24, "Test printS_5x7"); break;
        
        case 9: LCD_clear(); printS_5x7(10, 8, "Thank you very much ^^!"); break;

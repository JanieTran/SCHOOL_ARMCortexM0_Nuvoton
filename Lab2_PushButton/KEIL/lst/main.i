...
int main(void)
{
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKDIV = 11;
	...
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) -> TCSR |= 1ul << 16;
	
	
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) -> TCSR |= 1ul << 24;
	
	
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) -> TCSR |= 1ul << 26;
	
	
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) -> TCSR &= ~(0x03ul << 27);
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) -> TCSR |= 0x02ul << 27;
	...
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) -> TEXCON &= ~(1ul << 0);
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) -> TEXCON &= ~(0x03ul << 1);
	
	
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) -> TEXCON |= 1ul << 3;
	...
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040)) -> PMD &= ~(0x03ul << 30);
	
	
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> PMD &= ~(0x03ul << 24);
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> PMD |= 1ul << 24;
	...
	while (1) {
		if (((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) -> TDR == 5) {
			((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> DOUT ^= 1 << 12;
			((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) -> TEXCON |= 1ul << 4;
		}
	}
}

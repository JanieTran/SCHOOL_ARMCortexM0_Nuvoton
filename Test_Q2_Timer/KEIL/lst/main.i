...
int main(void)
{
	...
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000)) -> GPB_MFP |= 1ul << 11;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000)) -> ALT_MFP &= ~(1ul << 4);
	
	
	
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL1 &= ~(0x07ul << 20);
	
	
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> APBCLK |= 1ul << 5;
	
	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020)) -> TCSR &= ~(0xFFul << 0);
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020)) -> TCSR |= 0x0Bul << 0;
	
	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020)) -> TCSR &= ~(1ul << 26);
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020)) -> TCSR |= 1ul << 26;
	
	
	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020)) -> TCSR &= ~(0x03ul << 27);
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020)) -> TCSR |= 0x02ul << 27;
	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020)) -> TCSR &= ~(1ul << 24);
	
	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020)) -> TCSR |= 1ul << 16;
	
	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020)) -> TCMPR = 500000 - 1;
	
	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10020)) -> TCSR |= 1ul << 30;

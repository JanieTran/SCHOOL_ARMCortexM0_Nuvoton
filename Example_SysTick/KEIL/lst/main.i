...
int main(void)
{
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL0 |= 0x03ul<<3;
	...
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) ) -> VAL &= (~(0xFFFFFFul << 0));
	
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) ) -> LOAD &= (~(0xFFFFFFul << 0));
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) ) -> LOAD = 3000000;
	...
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> PMD |= (0x01ul) << 24;

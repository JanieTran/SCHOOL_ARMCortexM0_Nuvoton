...
int main(void)
{
  ...
  SYS_UnlockReg();
	...
	((SPI_T *) ((( uint32_t)0x40100000) + 0x34000)) -> CNTRL &= ~(0x1Ful << 3);
	
	((SPI_T *) ((( uint32_t)0x40100000) + 0x34000)) -> CNTRL |= 1ul << 2;
	((SPI_T *) ((( uint32_t)0x40100000) + 0x34000)) -> CNTRL |= 1ul << 1;
	...
	((SPI_T *) ((( uint32_t)0x40100000) + 0x34000)) -> SSR &= ~(1ul << 4);
	
	((SPI_T *) ((( uint32_t)0x40100000) + 0x34000)) -> SSR |= 1ul << 3;
	
	((SPI_T *) ((( uint32_t)0x40100000) + 0x34000)) -> SSR &= ~(1ul << 2);
	
	((SPI_T *) ((( uint32_t)0x40100000) + 0x34000)) -> SSR &= ~(0x03ul << 0);
	((SPI_T *) ((( uint32_t)0x40100000) + 0x34000)) -> SSR |= 1ul << 0;
	
	
	
	((SPI_T *) ((( uint32_t)0x40100000) + 0x34000)) -> TX[0] = 0xCDEB;

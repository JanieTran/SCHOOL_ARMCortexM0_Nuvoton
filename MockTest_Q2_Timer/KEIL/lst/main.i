...
int main(void)
{
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> PLLCON |= 0x08ul << 0;
	...
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000)) -> GPB_MFP |= 1ul << 10;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000)) -> ALT_MFP &= ~(1ul << 0);
	
	
	
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL1 &= 0x07 << 16;
	
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL1 |= 0x02 << 16;
	...
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000)) -> TCSR |= 0x02ul << 27;
	...
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000)) -> TCMPR = 100000 - 1;

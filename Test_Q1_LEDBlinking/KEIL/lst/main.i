...
int main(void)
{
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL0 |= 0x02 << 0;
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL0 &= ~(0x07ul << 3);
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL0 |= 1ul << 3;
	
	
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) ) -> LOAD = 16384 - 1;
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) ) -> VAL = 0;
	...
	while (1) {
		...
		while (!(((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) ) -> CTRL & (1ul << 16)));

...
int main(void)
{
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> PLLCON &= ~(0x1Ful << 9);
	
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> PLLCON |= 0x04 << 9;
	
	
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> PLLCON &= ~(0x03ul << 14);
	...
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) ) -> LOAD = 3000000 - 1;
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) ) -> VAL = 0;
	...
	while (1) {
		...
		((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> DOUT ^= 1ul << 14;
	}
}

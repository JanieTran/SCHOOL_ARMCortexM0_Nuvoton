...
int main(void)
{
   ...
   SYS_UnlockReg();
	...
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> PMD &= ~(0xFFul << 24);
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> PMD |= (0x55ul << 24);
	...
	while (1) {
		((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> DOUT |= 0x0Ful << 12;
		((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> DOUT &= ~(1ul << 12);
		Delay_s(2350000);
		((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> DOUT |= 0x0Ful << 12;
		((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> DOUT &= ~(1ul << 13);
		Delay_s(2350000);
		((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> DOUT |= 0x0Ful << 12;

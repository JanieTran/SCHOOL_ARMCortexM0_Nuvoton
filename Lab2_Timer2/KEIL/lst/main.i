...
int main(void)
{
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> PLLCON |= 38 << 0;
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL1 &= ~(0x07ul << 16);
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL1 |= 0x02ul << 16;
	
	
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> APBCLK |= 1ul << 4;
	
	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000)) -> TCSR &= ~(0xFFul << 0);
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000)) -> TCSR |= 39 << 0;
	
	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000)) -> TCSR |= 1ul << 26;
	
	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000)) -> TCSR &= ~(0x03ul << 27);
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000)) -> TCSR |= 1ul << 27;
	
	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000)) -> TCSR &= ~(1ul << 24);
	
	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000)) -> TCSR |= 1ul << 16;
	
	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000)) -> TCMPR = 250000 - 1;
	
	
	((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000)) -> TCSR |= 1ul << 30;
	
	
	
	
	
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> PMD &= ~(0x03ul << 30);
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> PMD |= 1ul << 30;
	...
	while (1) {
		while (!(((TIMER_T *) ((( uint32_t)0x40100000) + 0x10000)) -> TDR == (250000 - 1)));
		((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> DOUT ^= 1ul << 15;		
	}
}

...
int main(void)
{
	...
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> PMD &= ~(0x02ul << 26);
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> PMD |= 0x01ul << 26;
	
	
	
	
	
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) ) -> CTRL &= ~(0x01ul << 2);
	
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL0 &= ~(0x07ul << 3);
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL0 |= 0x01ul << 3;
	
	
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) ) -> LOAD = 4906 - 1;
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) ) -> VAL = 0;
	
	
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) ) -> CTRL |= 0x01ul << 0;
	...
	while (1) {
		while (!(((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) ) -> CTRL & (0x01ul << 16)));
		((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> DOUT ^= 1 << 13;
	}
}

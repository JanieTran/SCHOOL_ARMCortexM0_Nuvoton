...
int main(void)
{
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL0 &= ~(0x07ul << 0);
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKDIV &= ~(0x0Ful);
	
	
	
	
	
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> PMD &= ~(0x03ul << 28);
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> PMD |= 0x01 << 28;
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL1 |= 0x01ul << 8;
	...
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) -> TCSR |= 0x01ul << 27;
	...
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) -> TCMPR = 16384;	
	...
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000)) -> GPB_MFP |= 0x01ul << 9;
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000)) -> ALT_MFP &= ~(0x01ul << 1);
	
	
	
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL1 &= ~(0x07ul << 12);
	
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKSEL1 |= 0x02ul << 12;
	
	
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> APBCLK |= 0x01ul << 3;
	
	
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020)) -> TCSR &= ~(0xFFul << 0);
	
	
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020)) -> TCSR |= 0x01ul << 26;
	
	
	
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020)) -> TCSR &= ~(0x03ul << 27);
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020)) -> TCSR |= 0x02ul << 27;
	
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020)) -> TCSR &= ~(0x01ul << 24);
	
	
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020)) -> TCSR |= 0x01ul << 16;
	
	
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020)) -> TCMPR = 6000;
	
	
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020)) -> TCSR |= 1ul << 30;
	...
	while (1) {
		...
		while (!(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)) -> TDR == 16384));
		((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080)) -> DOUT ^= 1 << 14;
	}
}

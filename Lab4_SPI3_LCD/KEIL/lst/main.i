...
int main(void)
{
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON |= 8;
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON &= ~(1ul<<18);
	while(!(((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSTATUS & (0x01ul << 2)));
	...
	((CLK_T *) ((( uint32_t)0x50000000) + 0x00200)) -> CLKDIV &= ~(0x0Ful << 0);
	...
	((SPI_T *) ((( uint32_t)0x40100000) + 0x34000)) -> CNTRL &= ~(0x03ul << 8);
	
	((SPI_T *) ((( uint32_t)0x40100000) + 0x34000)) -> CNTRL &= ~(31ul << 3);
	((SPI_T *) ((( uint32_t)0x40100000) + 0x34000)) -> CNTRL |= 0x09ul << 3;
	
	((SPI_T *) ((( uint32_t)0x40100000) + 0x34000)) -> CNTRL |= 1ul << 2;
	
	
	((SPI_T *) ((( uint32_t)0x40100000) + 0x34000)) -> DIVIDER = 24;
